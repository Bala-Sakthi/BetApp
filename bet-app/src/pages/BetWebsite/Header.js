...
{/* <Nav.Link href="/pnr-status">Home</Nav.Link> */}
  ...
  <Nav.Link className="nav-link" href="/about-us"style={{color:"#6B78B7",fontSize:"16px",}}>About Us</Nav.Link>
  <Nav.Link className="nav-link" href="/faq"style={{color:"#6B78B7",fontSize:"16px"}}>FAQ</Nav.Link>
