...
import { useGetGroupQuery, useDeleteGroupMutation, useAddGroupMutation, useGetPhoneNumberQuery, useAddGroupNotificationMutation } from "../../../redux/api/GroupApi";
...
const Group = () => {
  ...
  const { data: phoneData, isLoading: numberLoading ,refetch} = useGetPhoneNumberQuery();
        ...
        <>
          ...
          <Modal show={showModal} onHide={() => setShowModal(false)} centered>
            ...
            <Modal.Footer>
              ...
              <Button style={{ backgroundColor: "#6B78B7", border: "none" }} onClick={handleSendRequest}>
                Send
              </Button>
            </Modal.Footer>
          </Modal>
